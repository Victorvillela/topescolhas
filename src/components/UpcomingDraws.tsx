...
export default function UpcomingDraws() {
  ...
  useEffect(() => {
    // Calcular próximo sorteio de cada loteria
    const now = new Date()
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            <Link href="/loterias" className="text-brand-400 hover:text-brand-300 text-sm font-semibold mr-2">
              Ver todas
            </Link>
            <button
              onClick={() => scroll('left')}
