...
//
// ⚠️ Slugs alinhados com lotteries.ts
// ============================================
...
const LOTTOLAND_MAP: Record<string, LottolandConfig> = {
  ...
  'za-lotto':          { apiName: 'saLotto',            currency: 'ZAR', symbol: 'R',   locale: 'en-ZA' },
  'za-powerball':      { apiName: 'saPowerball',        currency: 'ZAR', symbol: 'R',   locale: 'en-ZA' },
  'za-dailylotto':     { apiName: 'saDailyLotto',       currency: 'ZAR', symbol: 'R',   locale: 'en-ZA' },
  ...
  'ph-ultralotto':     { apiName: 'phUltraLotto',       currency: 'PHP', symbol: '₱',   locale: 'en-PH' },
  'ph-grandlotto':     { apiName: 'phGrandLotto',       currency: 'PHP', symbol: '₱',   locale: 'en-PH' },
}
