    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 animate-fade-in">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-white font-bold text-2xl">{t.auth.registerTitle}</h1>
          <p className="text-dark-400 text-sm mt-1">{t.auth.registerSubtitle}</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-dark-900/50 border border-white/5 rounded-2xl p-6 space-y-4">
          ...
          <div>
            <label className="text-dark-400 text-xs font-semibold uppercase tracking-wider mb-1.5 block">{t.auth.name}</label>
          ...
          <div>
            ...
            <p className="text-dark-500 text-[10px] mt-1">{t.auth.minPassword}</p>
          </div>
